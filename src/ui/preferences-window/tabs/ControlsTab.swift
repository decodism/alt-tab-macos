...
class ControlsTab {
    ...
    static var shortcutTriggerable = [
        ...
        "toggleFullscreenWindowShortcut": { Windows.focusedWindow() != nil && !Windows.focusedWindow()!.isWindowlessApp },
        "newWindowAppShortcut": { Windows.focusedWindow() != nil && Windows.focusedWindow()!.application.newWindowMenuItemElement != nil },
    ...
    static var shortcutsActions = [
        ...
        "newWindowAppShortcut": { App.app.newWindowSelectedApp() },
    ...
    static func initTab() -> NSView {
        ...
        let toggleFullscreenWindowShortcut = LabelAndControl.makeLabelWithRecorder(NSLocalizedString("Toggle fullscreen window", comment: ""), "toggleFullscreenWindowShortcut", Preferences.toggleFullscreenWindowShortcut, labelPosition: .right)
        let newWindowAppShortcut = LabelAndControl.makeLabelWithRecorder(NSLocalizedString("New window (⌘ + N)", comment: ""), "newWindowAppShortcut", Preferences.newWindowAppShortcut, labelPosition: .right)
        ...
        let shortcuts = StackView([focusWindowShortcut, previousWindowShortcut, cancelShortcut, closeWindowShortcut, minDeminWindowShortcut, quitAppShortcut, toggleFullscreenWindowShortcut, newWindowAppShortcut, hideShowAppShortcut].map { (view: [NSView]) in StackView(view) }, .vertical)
